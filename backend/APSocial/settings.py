"""
Django settings for APSocial project.
...
SECRET_KEY = 'django-insecure-ccd6214@*gar_$sl%evmta@1&e+o33(og$h-2d=&3oe9y0#@y+'
...
EMAIL_HOST_PASSWORD = 'rvmj caxr awzu iyui'
...
WSGI_APPLICATION = 'APSocial.wsgi.application'
